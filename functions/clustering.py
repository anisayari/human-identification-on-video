...
import logging
import numpy as np
from functions.detect_face import init_mtcnn,get_face
...
def run_PCA(aligned,names, plot=True):
    ...
    if plot:
        ...
        fig.write_html("plot/explained_variance_kmeans.html")
        """
...
def run_clustering_algorithm(X_pca1,y,number_of_clusters):
    ...
    fig.write_html("./plot/kmeans.html")
